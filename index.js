  ...
  $('#loginForm').submit(function (event) {
    ...
    if (user) {
      ...
      if (user.role === 'admin') {
        ...
        $('.nav-item:last-child .dropdown-menu').html('<li class="logout-btn"><a class="dropdown-item" href="index.html" onclick="logout()"><i class="bi bi-box-arrow-left"></i> Đăng Xuất</a></li><li><li><hr class="dropdown-divider"></li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#userListModal"><i class="bi bi-person-lines-fill"></i> User list</a></li>');
      } else {
        // Nếu là user, ẩn nút Xem Danh Sách Người Dùng
        $('.nav-item:last-child .dropdown-menu').html('<li class="logout-btn"><a class="dropdown-item" href="index.html" onclick="logout()"><i class="bi bi-box-arrow-left"></i> Đăng Xuất</a></li>');
      }
